...
public class Flags {
    ...
    public static void eduReform() {
        ...
        if ((double) yes * 100 / yes + no + none >= 60)
            System.out.println("the system will change");
        else
            System.out.println("the system will not change");
    }
    ...
    public static void guessChar() {
        ...
        if (guessed == randomChar)
            if (tries != 0)
                System.out.println("Guessed after " + (5 - tries) + "tries");
            else
                System.out.println("You guessed but ran out of tries");
        else
    ...
    public static void coinFlip() {
        ...
        if (countShir == 3)
            System.out.println("Shir starts");
        else if (countLee == 3)
            System.out.println("Lee starts");
    }
    ...
    // a, c, e, g
    // a
    // print all letters from a - input, with jumps of 2 (a, c, e, ..., input(if in
    // jumps))
    ...
    public static void similarNumbers() {
        ...
        while (n1 < 100 && n2 < 100) {
            if ((n1 % 10 == n2 % 10 && n1 / 10 == n2 / 10) || (n1 % 10 == n2 / 10
                ...
                System.out.println("Your numbers arent similar");
